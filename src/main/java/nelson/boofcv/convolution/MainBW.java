...
public class MainBW {
    ...
    public static void main(String[] args) throws IOException {
        ...
        final GrayU8 bandIn = input.getBand(1);
        final GrayU8 bandOut = bandIn.createNew(bandIn.width, bandIn.height);
        ...
        GConvolveImageOps.convolve(kernel, input, bandOut);

        //final Planar<GrayU8> normalized = normalize(bandOut, kernel.computeSum());

        UtilImageIO.saveImage(bandOut, OUTPUT.getAbsolutePath());
    }
    ...
    private static Kernel2D_F32 normalizeKernel(Kernel2D_S32 kernel) {
